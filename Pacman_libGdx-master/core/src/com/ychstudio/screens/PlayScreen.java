...
public class PlayScreen implements Screen {
    ...
    public void show() {
        ...
        font = new BitmapFont(Gdx.files.internal("core/assets/fonts/army_stencil.fnt"));
        ...
        TextureAtlas textureAtlas = GameManager.instance.assetManager.get("core/assets/images/actors.pack", TextureAtlas.class);
    ...
    public void render(float delta) {
        ...
        if (GameManager.instance.totalPills <= 0 && !changeScreen) {
            GameManager.instance.assetManager.get("core/assets/sounds/clear.ogg", Sound.class).play();
            changeScreen = true;
        }

...
public class GameManager implements Disposable {
    ...
    private GameManager() {
        ...
        assetManager.load("core/assets/images/actors.pack", TextureAtlas.class);
        assetManager.load("core/assets/sounds/pill.ogg", Sound.class);
        assetManager.load("core/assets/sounds/big_pill.ogg", Sound.class);
        assetManager.load("core/assets/sounds/ghost_die.ogg", Sound.class);
        assetManager.load("core/assets/sounds/pacman_die.ogg", Sound.class);

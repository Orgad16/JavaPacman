    ...
    protected void processEntity(Entity entity, float deltaTime) {
        ...
        if (pill.eaten) {
            if (pill.big) {
                ...
                GameManager.instance.assetManager.get("core/assets/sounds/big_pill.ogg", Sound.class).play();
            } else {
                GameManager.instance.addScore(100);
                GameManager.instance.assetManager.get("core/assets/sounds/pill.ogg", Sound.class).play();
            }
